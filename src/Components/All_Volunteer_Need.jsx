            ...
            <div className="w-11/12 mx-auto">
                <div className="flex items-center">
                    <div className="relative w-full my-4 max-w-xl mx-auto bg-white rounded-full">
                        <input placeholder="search" className="rounded-full w-full  bg-transparent py-2 pl-8   outline-none border-2 border-gray-100 shadow-md hover:outline-none " type="text" name="query" id="query" />
                        <button type="submit" className="absolute  inline-flex items-center  px-4 py-2 text-sm text-white transition duration-150 ease-in-out rounded-full outline-none right-3 top-1 bg-secondary sm:px-6 sm:text-base sm:font-medium hover:bg-secondary ">
